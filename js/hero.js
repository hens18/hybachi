...
(() => {
  ...
  const VIDEO_BYTES = 7526345; // real size, used when Content-Length is missing
  ...
  function initHeroOnce() {
    ...
    // Poster: the film's first frame, then the real truck photo.
    const posters = [POSTER, POSTER_FALLBACK];
    const tryPoster = () => {
